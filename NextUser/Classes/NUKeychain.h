...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, NUKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    NUKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const kNUKeychainErrorDomain;

/** Account name. */
extern NSString *const kNUKeychainAccountKey;
 ...
 */
extern NSString *const kNUKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kNUKeychainClassKey;

/** Item description. */
extern NSString *const kNUKeychainDescriptionKey;

/** Item label. */
extern NSString *const kNUKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kNUKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kNUKeychainWhereKey;
