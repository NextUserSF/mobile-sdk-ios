...
NS_ASSUME_NONNULL_BEGIN
    ...
    #define NUKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
    // Keychain access group available at compile time
    #define NUKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef NUKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, NUKeychainQuerySynchronizationMode) {
    NUKeychainQuerySynchronizationModeAny,
    NUKeychainQuerySynchronizationModeNo,
    NUKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface NUKeychainQuery : NSObject
...
@property (nonatomic) NUKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 NUKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
